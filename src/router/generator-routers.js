...
const constantRouterComponents = {
  ...
  // test
  'Example': () => import('@/views/test/Example'),

  // monitor
  'HttpTrace': () => import('@/views/monitor/HttpTrace'),
  'JvmInfo': () => import('@/views/monitor/JvmInfo'),
  'SystemInfo': () => import('@/views/monitor/SystemInfo'),
  'TomcatInfo': () => import('@/views/monitor/TomcatInfo'),
  'DiskMonitoring': () => import('@/views/monitor/DiskMonitoring'),

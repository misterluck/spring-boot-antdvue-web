              ...
              >
                ...
                >
                  ...
                  <template v-for="(id,i) in [`${col.key}${row.id}`]">
                    ...
                    <div
                      v-else-if="col.type === formTypes.upload"
                      :key="i"
                    >
                      <template
                    ...
                    <div
                      v-else-if="col.type === formTypes.file"
                      :key="i"
                    >
                      <template
                        v-if="uploadValues[id] != null"
                    ...
                    <div
                      v-else-if="col.type === formTypes.image"
                      :key="i"
                    >
                      <template
                        v-if="uploadValues[id] != null"
                    ...
                    <div
                      v-else-if="col.type === formTypes.slot"
                      :key="i"
                    >
                      <slot
